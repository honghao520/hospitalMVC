...
public class SqlCommand {
    ...
    public String Registered(String department) {
        String sql = "INSERT INTO " + department + "(patient_id,judge) VALUES(?,'1');";
        return sql;
    }
    ...
    /**
     * @description: 通过挂号号码查询病人信息
     */
    public String selectPatientInfo(String department) {
        String sql = "select id,name,sex,age from patient where id =(\n" +
                "select patient_id from " + department + " where id = ? and judge = 1); ";
        return sql;
    }
     ...
     */
    public String selectNum(String department) {
        String sql = "select id from " + department + " where judge = ?;";
        return sql;
    }
}
